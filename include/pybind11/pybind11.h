...
#    pragma GCC diagnostic pop
...

        {
            ...
            static_assert(!(has_args && has_kwonly_args),
    ...
    void initialize_generic(detail::function_record *rec,
                            const char *text,
    ...
    m_base.attr(op) = cpp_function(                                                               \
        ...
        if (is_convertible) {
            ...
            if (is_arithmetic) {
                ...
                m_base.attr("__invert__") = cpp_function([](object arg) { return ~(int_(arg)); },
                                                         name("__invert__"),
                                                         is_method(m_base));
            }
        } else {
...
register_exception(handle scope, const char *name, PyObject *base = PyExc_Exception) {
...
/** \rst
 ...
 this_ptr.
  ...
  :this_ptr: The pointer to the object the overload should be retrieved for. This should be the
 first non-trampoline class encountered in the inheritance chain. :name: The name of the overloaded
 Python method to retrieve. :return: The Python method by this name from the object or an empty
 function wrapper. \endrst */
template <class T>
...
:c:macro:`PYBIND11_OVERLOAD_NAME`, except that it throws if no overload can be found. \endrst */
...
/** \rst
    Macro for pure virtual functions, this function is identical to :c:macro:`PYBIND11_OVERLOAD`,
except that it throws if no overload can be found. \endrst */
